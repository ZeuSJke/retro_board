      ...
      >
        ...
        >
          <div style={{ ...styles.author, color: subtleColor }}>
            <div style={{ ...styles.avatar, background: userColor(card.author) }}>
...
const styles = {
  ...
  text: { fontSize: 14, lineHeight: 1.55, wordBreak: 'break-word' },
  editTextarea: {
    width: '100%',
  ...
  likeCount: { minWidth: 8, display: 'inline-block', textAlign: 'center' },
  iconBtn: {
    width: 28,
    height: 28,
    borderRadius: '50%',
